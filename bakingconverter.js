    ...
    startUnit and endUnit must be 'tsp', 'tbsp', 'pints', 'quarts', 'gallons', 'fl oz', or 'mL'

    */
const bakingConverter = (startAmount, startUnit, endUnit) => {
    const bakingConversions = (startAmount, startUnit, endUnit) => {
    ...
    const finalAmount = bakingConverter(startAmount, startUnit, endUnit);
    if (finalAmount % 1 === 0) {
        return finalAmount;
    } else {
